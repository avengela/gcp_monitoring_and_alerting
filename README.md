...
The goal of this project is to set up a central infrastructure monitoring system that detects failures and sends notifications to Cloud Monitoring. The project involves creating a test environment in Google Cloud with several virtual machines, monitoring their status, and responding to failures through alerts.
...
4. **Alert for failed uptime check**
...
6. **Alert for syslog error spikes**
